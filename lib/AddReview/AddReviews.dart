...
class AddReview extends StatelessWidget {
  ...
  final String serviceName;
   AddReview({super.key,required this.uidPublisher,required this.serviceName});
   ...
   if(AppCubit.get(context).userdata!.image==''||AppCubit.get(context).userdata!.image==null){
    ...
    return BlocConsumer<AppCubit, AppStates>(
      listener: (context, state) {
          if(state is AddServiceReviewSuccessState){
      ...
      builder: (context, state) {
        ...
        AppCubit.get(context).uploadReviewImages(
        image: image!,
