...
class AllUserReviewsScreen extends StatefulWidget {
  AllUserReviewsScreen({super.key});
  final  formKey = GlobalKey<FormState>();

  @override
  State<AllUserReviewsScreen> createState() => _AllUserReviewsScreenState();
}

class _AllUserReviewsScreenState extends State<AllUserReviewsScreen> {
                ...
                child: Form(
                  ...
                  child: Column(
                      children: [
                        ...
                        ConditionalBuilder(
                          condition: AppCubit.get(context).AllReviews.isNotEmpty,
                          builder:(context)=> ListView.separated(
                            shrinkWrap: true,
                            physics: const BouncingScrollPhysics(),
                            itemBuilder: (context, index) => review(
                                AppCubit.get(context).AllReviews[index], context),
                            separatorBuilder: (context, index) => myDivider(),
                            itemCount: AppCubit.get(context).AllReviews.length,
